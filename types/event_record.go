...
// Sources:
// https://github.com/acala-js/api/blob/master/packages/api-augment/src/substrate/events.ts
// https://github.com/acala-js/api/blob/master/packages/api-augment/src/acala/events.ts
//
//nolint:stylecheck,lll,revive
type EventRecords struct {
	Auctions_AuctionStarted     []EventAuctionsAuctionStarted     `test-gen-blockchain:"acala"`
	Auctions_AuctionClosed      []EventAuctionsAuctionClosed      `test-gen-blockchain:"acala"`
	Auctions_Reserved           []EventAuctionsReserved           `test-gen-blockchain:"acala"`
	Auctions_Unreserved         []EventAuctionsUnreserved         `test-gen-blockchain:"acala"`
	Auctions_ReserveConfiscated []EventAuctionsReserveConfiscated `test-gen-blockchain:"acala"`
	Auctions_BidAccepted        []EventAuctionsBidAccepted        `test-gen-blockchain:"acala"`
	Auctions_WinningOffset      []EventAuctionsWinningOffset      `test-gen-blockchain:"acala"`
	...
	BagsList_Rebagged []EventBagsListRebagged `test-gen-blockchain:"acala"`
	...
	Bounties_BountyProposed     []EventBountiesBountyProposed     `test-gen-blockchain:"acala"`
	Bounties_BountyRejected     []EventBountiesBountyRejected     `test-gen-blockchain:"acala"`
	Bounties_BountyBecameActive []EventBountiesBountyBecameActive `test-gen-blockchain:"acala"`
	Bounties_BountyAwarded      []EventBountiesBountyAwarded      `test-gen-blockchain:"acala"`
	Bounties_BountyClaimed      []EventBountiesBountyClaimed      `test-gen-blockchain:"acala"`
	Bounties_BountyCanceled     []EventBountiesBountyCanceled     `test-gen-blockchain:"acala"`
	Bounties_BountyExtended     []EventBountiesBountyExtended     `test-gen-blockchain:"acala"`
	...
	Claims_Claimed []EventClaimsClaimed `test-gen-blockchain:"acala"`
	...
	Crowdloan_Created           []EventCrowdloanCreated           `test-gen-blockchain:"acala"`
	Crowdloan_Contributed       []EventCrowdloanContributed       `test-gen-blockchain:"acala"`
	Crowdloan_Withdrew          []EventCrowdloanWithdrew          `test-gen-blockchain:"acala"`
	Crowdloan_PartiallyRefunded []EventCrowdloanPartiallyRefunded `test-gen-blockchain:"acala"`
	Crowdloan_AllRefunded       []EventCrowdloanAllRefunded       `test-gen-blockchain:"acala"`
	Crowdloan_Dissolved         []EventCrowdloanDissolved         `test-gen-blockchain:"acala"`
	Crowdloan_HandleBidResult   []EventCrowdloanHandleBidResult   `test-gen-blockchain:"acala"`
	Crowdloan_Edited            []EventCrowdloanEdited            `test-gen-blockchain:"acala"`
	Crowdloan_MemoUpdated       []EventCrowdloanMemoUpdated       `test-gen-blockchain:"acala"`
	Crowdloan_AddedToNewRaise   []EventCrowdloanAddedToNewRaise   `test-gen-blockchain:"acala"`
	...
	ElectionProviderMultiPhase_SolutionStored       []EventElectionProviderMultiPhaseSolutionStored       `test-gen-blockchain:"acala"`
	ElectionProviderMultiPhase_ElectionFinalized    []EventElectionProviderMultiPhaseElectionFinalized    `test-gen-blockchain:"acala"`
	ElectionProviderMultiPhase_Rewarded             []EventElectionProviderMultiPhaseRewarded             `test-gen-blockchain:"acala"`
	ElectionProviderMultiPhase_Slashed              []EventElectionProviderMultiPhaseSlashed              `test-gen-blockchain:"acala"`
	ElectionProviderMultiPhase_SignedPhaseStarted   []EventElectionProviderMultiPhaseSignedPhaseStarted   `test-gen-blockchain:"acala"`
	ElectionProviderMultiPhase_UnsignedPhaseStarted []EventElectionProviderMultiPhaseUnsignedPhaseStarted `test-gen-blockchain:"acala"`
	...
	Grandpa_NewAuthorities []EventGrandpaNewAuthorities `test-gen-blockchain:"acala"`
	Grandpa_Paused         []EventGrandpaPaused         `test-gen-blockchain:"acala"`
	Grandpa_Resumed        []EventGrandpaResumed        `test-gen-blockchain:"acala"`

	Hrmp_OpenChannelRequested []EventHRMPOpenChannelRequested `test-gen-blockchain:"acala"`
	Hrmp_OpenChannelCanceled  []EventHRMPOpenChannelCanceled  `test-gen-blockchain:"acala"`
	Hrmp_OpenChannelAccepted  []EventHRMPOpenChannelAccepted  `test-gen-blockchain:"acala"`
	Hrmp_ChannelClosed        []EventHRMPChannelClosed        `test-gen-blockchain:"acala"`
	...
	ImOnline_AllGood           []EventImOnlineAllGood           `test-gen-blockchain:"acala"`
	ImOnline_HeartbeatReceived []EventImOnlineHeartbeatReceived `test-gen-blockchain:"acala"`
	ImOnline_SomeOffline       []EventImOnlineSomeOffline       `test-gen-blockchain:"acala"`

	Indices_IndexAssigned []EventIndicesIndexAssigned `test-gen-blockchain:"acala"`
	Indices_IndexFreed    []EventIndicesIndexFreed    `test-gen-blockchain:"acala"`
	Indices_IndexFrozen   []EventIndicesIndexFrozen   `test-gen-blockchain:"acala"`
	...
	Offences_Offence []EventOffencesOffence `test-gen-blockchain:"acala"`

	Paras_CurrentCodeUpdated   []EventParasCurrentCodeUpdated   `test-gen-blockchain:"acala"`
	Paras_CurrentHeadUpdated   []EventParasCurrentHeadUpdated   `test-gen-blockchain:"acala"`
	Paras_CodeUpgradeScheduled []EventParasCodeUpgradeScheduled `test-gen-blockchain:"acala"`
	Paras_NewHeadNoted         []EventParasNewHeadNoted         `test-gen-blockchain:"acala"`
	Paras_ActionQueued         []EventParasActionQueued         `test-gen-blockchain:"acala"`
	Paras_PvfCheckStarted      []EventParasPvfCheckStarted      `test-gen-blockchain:"acala"`
	Paras_PvfCheckAccepted     []EventParasPvfCheckAccepted     `test-gen-blockchain:"acala"`
	Paras_PvfCheckRejected     []EventParasPvfCheckRejected     `test-gen-blockchain:"acala"`
	...
	ParaInclusion_CandidateBacked   []EventParaInclusionCandidateBacked   `test-gen-blockchain:"acala"`
	ParaInclusion_CandidateIncluded []EventParaInclusionCandidateIncluded `test-gen-blockchain:"acala"`
	ParaInclusion_CandidateTimedOut []EventParaInclusionCandidateTimedOut `test-gen-blockchain:"acala"`
	...
	Scheduler_CallLookupFailed []EventSchedulerCallLookupFailed `test-gen-blockchain:"acala"`
	Scheduler_Canceled         []EventSchedulerCanceled         `test-gen-blockchain:"acala"`
	Scheduler_Dispatched       []EventSchedulerDispatched       `test-gen-blockchain:"acala"`
	Scheduler_Scheduled        []EventSchedulerScheduled        `test-gen-blockchain:"acala"`

	Session_NewSession []EventSessionNewSession `test-gen-blockchain:"centrifuge-parachain"`

	Slots_NewLeasePeriod []EventSlotsNewLeasePeriod `test-gen-blockchain:"acala"`
	Slots_Leased         []EventSlotsLeased         `test-gen-blockchain:"acala"`
	...
	Staking_Bonded                     []EventStakingBonded                     `test-gen-blockchain:"acala"`
	Staking_Chilled                    []EventStakingChilled                    `test-gen-blockchain:"acala"`
	Staking_EraPaid                    []EventStakingEraPaid                    `test-gen-blockchain:"acala"`
	Staking_Kicked                     []EventStakingKicked                     `test-gen-blockchain:"acala"`
	Staking_OldSlashingReportDiscarded []EventStakingOldSlashingReportDiscarded `test-gen-blockchain:"acala"`
	Staking_PayoutStarted              []EventStakingPayoutStarted              `test-gen-blockchain:"acala"`
	Staking_Rewarded                   []EventStakingRewarded                   `test-gen-blockchain:"acala"`
	Staking_Slashed                    []EventStakingSlashed                    `test-gen-blockchain:"acala"`
	Staking_StakersElected             []EventStakingStakersElected             `test-gen-blockchain:"acala"`
	Staking_StakingElectionFailed      []EventStakingStakingElectionFailed      `test-gen-blockchain:"acala"`
	Staking_Unbonded                   []EventStakingUnbonded                   `test-gen-blockchain:"acala"`
	Staking_Withdrawn                  []EventStakingWithdrawn                  `test-gen-blockchain:"acala"`
	...
	TechnicalCommittee_Approved       []EventTechnicalCommitteeApproved       `test-gen-blockchain:"acala"`
	TechnicalCommittee_Closed         []EventTechnicalCommitteeClosed         `test-gen-blockchain:"acala"`
	TechnicalCommittee_Disapproved    []EventTechnicalCommitteeDisapproved    `test-gen-blockchain:"acala"`
	TechnicalCommittee_Executed       []EventTechnicalCommitteeExecuted       `test-gen-blockchain:"acala"`
	TechnicalCommittee_MemberExecuted []EventTechnicalCommitteeMemberExecuted `test-gen-blockchain:"acala"`
	TechnicalCommittee_Proposed       []EventTechnicalCommitteeProposed       `test-gen-blockchain:"acala"`
	TechnicalCommittee_Voted          []EventTechnicalCommitteeVoted          `test-gen-blockchain:"acala"`

	TechnicalMembership_Dummy          []EventTechnicalMembershipDummy          `test-gen-blockchain:"acala"`
	TechnicalMembership_KeyChanged     []EventTechnicalMembershipKeyChanged     `test-gen-blockchain:"acala"`
	TechnicalMembership_MemberAdded    []EventTechnicalMembershipMemberAdded    `test-gen-blockchain:"acala"`
	TechnicalMembership_MemberRemoved  []EventTechnicalMembershipMemberRemoved  `test-gen-blockchain:"acala"`
	TechnicalMembership_MembersReset   []EventTechnicalMembershipMembersReset   `test-gen-blockchain:"acala"`
	TechnicalMembership_MembersSwapped []EventTechnicalMembershipMembersSwapped `test-gen-blockchain:"acala"`

	Tips_NewTip       []EventTipsNewTip       `test-gen-blockchain:"acala"`
	Tips_TipClosed    []EventTipsTipClosed    `test-gen-blockchain:"acala"`
	Tips_TipClosing   []EventTipsTipClosing   `test-gen-blockchain:"acala"`
	Tips_TipRetracted []EventTipsTipRetracted `test-gen-blockchain:"acala"`
	Tips_TipSlashed   []EventTipsTipSlashed   `test-gen-blockchain:"acala"`
	...
	Ump_InvalidFormat          []EventUMPInvalidFormat          `test-gen-blockchain:"acala"`
	Ump_UnsupportedVersion     []EventUMPUnsupportedVersion     `test-gen-blockchain:"acala"`
	Ump_ExecutedUpward         []EventUMPExecutedUpward         `test-gen-blockchain:"acala"`
	Ump_WeightExhausted        []EventUMPWeightExhausted        `test-gen-blockchain:"acala"`
	Ump_UpwardMessagesReceived []EventUMPUpwardMessagesReceived `test-gen-blockchain:"acala"`
	Ump_OverweightEnqueued     []EventUMPOverweightEnqueued     `test-gen-blockchain:"acala"`
	Ump_OverweightServiced     []EventUMPOverweightServiced     `test-gen-blockchain:"acala"`
	...
	VoterList_Rebagged     []EventVoterListRebagged     `test-gen-blockchain:"acala"`
	VoterList_ScoreUpdated []EventVoterListScoreUpdated `test-gen-blockchain:"acala"`
	...
	XcmPallet_Attempted                 []EventXcmPalletAttempted                 `test-gen-blockchain:"acala"`
	XcmPallet_Sent                      []EventXcmPalletSent                      `test-gen-blockchain:"acala"`
	XcmPallet_UnexpectedResponse        []EventXcmPalletUnexpectedResponse        `test-gen-blockchain:"acala"`
	XcmPallet_ResponseReady             []EventXcmPalletResponseReady             `test-gen-blockchain:"acala"`
	XcmPallet_Notified                  []EventXcmPalletNotified                  `test-gen-blockchain:"acala"`
	XcmPallet_NotifyOverweight          []EventXcmPalletNotifyOverweight          `test-gen-blockchain:"acala"`
	XcmPallet_NotifyDispatchError       []EventXcmPalletNotifyDispatchError       `test-gen-blockchain:"acala"`
	XcmPallet_NotifyDecodeFailed        []EventXcmPalletNotifyDecodeFailed        `test-gen-blockchain:"acala"`
	XcmPallet_InvalidResponder          []EventXcmPalletInvalidResponder          `test-gen-blockchain:"acala"`
	XcmPallet_InvalidResponderVersion   []EventXcmPalletInvalidResponderVersion   `test-gen-blockchain:"acala"`
	XcmPallet_ResponseTaken             []EventXcmPalletResponseTaken             `test-gen-blockchain:"acala"`
	XcmPallet_AssetsTrapped             []EventXcmPalletAssetsTrapped             `test-gen-blockchain:"acala"`
	XcmPallet_VersionChangeNotified     []EventXcmPalletVersionChangeNotified     `test-gen-blockchain:"acala"`
	XcmPallet_SupportedVersionChanged   []EventXcmPalletSupportedVersionChanged   `test-gen-blockchain:"acala"`
	XcmPallet_NotifyTargetSendFail      []EventXcmPalletNotifyTargetSendFail      `test-gen-blockchain:"acala"`
	XcmPallet_NotifyTargetMigrationFail []EventXcmPalletNotifyTargetMigrationFail `test-gen-blockchain:"acala"`
}
